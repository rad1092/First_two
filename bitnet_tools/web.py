        ...
        try:
            ...
            if route == "/api/run":
                ...
                try:
                    ...
                    return self._send_json({"error": "timeout must be an integer"}, HTTPStatus.BAD_REQUEST)
                if timeout_s < 1 or timeout_s > 600:
                    return self._send_json({"error": "timeout must be between 1 and 600"}, HTTPStatus.BAD_REQUEST)
